...
import type { ScriptToStoryboardStepMeta, ScriptToStoryboardStepOutput } from '@/lib/novel-promotion/script-to-storyboard/common'
import { JsonParseError } from '@/lib/novel-promotion/script-to-storyboard/common'
...
const MAX_VOICE_ANALYZE_ATTEMPTS = 3
