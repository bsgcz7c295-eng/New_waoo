...
export const PROMPT_CATALOG: Record<PromptId, PromptCatalogEntry> = {
  ...
  [PROMPT_IDS.NP_IMAGE_PROMPT_MODIFY]: {
    ...
    version: 2, // v2: added scene/character description rules, POV rules, SRT language rules, JSON safety
  },
  ...
  [PROMPT_IDS.NP_SINGLE_PANEL_IMAGE]: {
    ...
    version: 2, // v2: added photography rules, source text priority, slot flexibility, reference image rules
  },
